    ...
    <>
      ...
      >
          ...
          <ul className="definitions-list">
            ...
            <li>
              <p>
                ...
                a website to store browsing history.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> - refers to Aeroin EduTech, accessible
                from https://aeroinedutech.in
              </p>
            </li>
            <p />
            <li>
        ...
        <section className="privacy-section">
          ...
          <h4 className="subsection-heading-small">Personal Data</h4>
          ...
          <h4 className="subsection-heading-small">Usage Data</h4>
          <p>
          ...
          <p>
            ...
            provide You with those services. <br />
            <br />
          </p>
          <li>
          ...
          <li>
            ...
            <p>
              ...
              re-enter your preferences every time You use the Website. <br />
              <br />
              For more information about the cookies we use and your choices
              regarding cookies, please visit our Cookies Policy or the Cookies
              section of our Privacy Policy. <br />
              <br />
            </p>
          </li>
          <p />
        ...
        <section className="privacy-section">
          <h2 className="section-heading">Use of Your Personal Data</h2>
          {/* <h4 class="subsection-heading-small">Personal Data</h4> */}
          <p>
            {" "}
        ...
        <section className="privacy-policy">
          <h2 className="section-heading">Retention of Your Personal Data</h2>
          <section className="privacy-section">
            <p>
              {" "}
        ...
        <section className="privacy-policy">
          <h2 className="section-heading">Transfer of Your Personal Data</h2>
          <section className="privacy-section">
            <p>
        ...
        <section className="privacy-policy">
          <h2 className="section-heading">Delete Your Personal Data</h2>
          <section className="privacy-section">
            <p>
              {" "}
        ...
        <section className="privacy-policy">
          <h2 className="section-heading">Disclosure of Your Personal Data</h2>
          <h4 className="subsection-heading-small">Business Transactions</h4>
          <p>
          ...
          <h4 className="subsection-heading-small">Law enforcement</h4>
          <p>
            {" "}
          ...
          <h4 className="subsection-heading-small">Other legal requirements</h4>
          <section className="privacy-section">
            <p>
        ...
        <section className="privacy-policy">
          <h4 className="subsection-heading-small">Children's Privacy</h4>
          <p>
